...
'╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═════╝░╚═╝░░╚═╝',
    ...
    #print('=============MAMBA==============')
    print(f'{lg}   Version: {w}1.0{lg} | Author: {w}MAMBA{rs}\n')
...
for a in accounts:
    ...
    clnt = TelegramClient(f'sessions/{phn}', 11279225, '47fd121660e3316525c7b369f2e97b85')
    clnt.connect()
    banned = []
...
for acc in to_use:
    stop = index + 60
    c = TelegramClient(f'sessions/{acc[0]}', 11279225 , '47fd121660e3316525c7b369f2e97b85')
